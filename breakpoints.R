...
#
# usage: $ Rscript breakpoints.R <input masterData rdata> <input covariateData rdata> <output springFallBPs rdata>
# example: $ Rscript breakpoints.R ./masterData.RData ./covariateData.RData ./springFallBPs.RData
